...
export default function MultiToolsChat() {
                                                ...
                                                return (
                                                    <div key={`${message.id}-getWeather-${index}`} className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-3 mb-3">
                                                        <div className="flex items-center gap-2 mb-2">
                                                            ...
                                                            <span className="text-blue-300 font-medium text-sm">Finding location...</span>
                                                        </div>
                                                ...
                                                return (
                                                    <div key={`${message.id}-getWeather-${index}`} className="bg-green-500/10 border border-green-500/20 rounded-lg p-3 mb-3">
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            <span className="text-green-300 text-sm">Getting location for <span className="font-semibold">{part.input.user}</span></span>
                                                        </div>
                                                    </div>
                                                )
                                                ...
                                                return (
                                                    <div key={`${message.id}-getWeather-${index}`} className="bg-emerald-500/10 border border-emerald-500/20 rounded-lg p-3 mb-3">
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            <span className="text-emerald-300 text-sm">Location found: <span className="font-semibold">{part.output}</span></span>
                                                        </div>
                                                    </div>
                                                )
                                            case "output-error":
